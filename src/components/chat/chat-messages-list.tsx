      ...
      >
        ...
        {messages.length === 0 && !isTyping && (
          <div className="flex h-full flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="mb-1 text-lg font-semibold text-soft-white">{emptyStateTitle}</h3>
            <p className="max-w-sm text-sm font-medium text-steel-gray">{emptyStateSubtitle}</p>
          </div>
        )}
        ...
        {isTyping && (
          <div className="mt-4 flex gap-2">
            ...
            <div className="flex items-center gap-1 rounded-2xl rounded-bl-sm bg-white/6 px-4 py-2">
