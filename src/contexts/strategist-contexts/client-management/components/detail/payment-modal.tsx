        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
              <CurrencyDollar className="h-5 w-5 text-steel-gray/60" />
            </div>
            <input
              type="number"
              value={paymentAmount}
              onChange={e => onAmountChange(Number(e.target.value))}
              className="w-full rounded-lg border border-white/15 py-2.5 pr-4 pl-10 text-soft-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none"
              placeholder="499"
              min={1}
            />
          </div>
