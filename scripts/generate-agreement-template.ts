 ...
 *
 * Run with: npx ts-node scripts/generate-agreement-template.ts
 *
 * This creates a DOCX file with:
 * - Dynamic data placeholders: {{client_name}}, {{price}}, etc.
 * - Signature field placeholder: [[client_signature]]
 */
